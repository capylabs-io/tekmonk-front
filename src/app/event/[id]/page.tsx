...
export default function Page({ params }: { params: { id: string } }) {
  const [title, setTitle] = useState(
    "Viewing party CKTG 2023 Đồng hành bởi Youtube Gaming",
  );
  const [eventTime, setEventTime] = useState(
    "Chủ Nhật, 03/12/2023 (15:00 - 23:00)",
  );
  const [eventVenue, setEventVenue] = useState("Nhà thi đấu Tây Hồ");
  const [address, setAddress] = useState(
    "Số 101 Đ. Xuân La, Xuân La, District Tay Ho, Ha Noi City",
  );
    ...
    <div className="mt-3">
      ...
      <div className="w-2/3 mx-auto border-r border-l border-b border-gray-200 h-max">
        ...
        <div className="p-4">
          ...
          <p>
            Sự kiện Viewing party CKTG 2023 Đồng hành bởi Youtube Gaming được
            diễn ra lúc 13h00 ngày 19/11/2023 tại 02 địa điểm
          </p>
          ...
          <ol>
            ...
            <li>
              Nhà thi đấu Tây Hồ - Số 101 Đ. Xuân La, Xuân La, Tây Hồ, Hà Nội
            </li>
          </ol>
          ...
          <ul>
            <li>
              Hạng vé Thách đấu: giá vé 249,000 đồng
              <ul>
                <li>
                  ​Quà tặng: ​01 Túi đeo chéo + 01 Túi vải + 01 code in-game +
                  lối đi ưu tiên & chỗ ngồi đẹp
                </li>
              </ul>
            </li>
            <li>
              Hạng vé Cao thủ: giá vé 149,000 đồng
              <ul>
                <li>​​​​​Quà tặng: 01 Nón bucket + vị trí ngồi đẹp</li>
              </ul>
            </li>
            <li>
              Hạng vé Kim cương: giá vé 99,000 đồng
              <ul>
