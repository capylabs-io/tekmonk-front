...
export default function BackgroundShop() {
    ...
    return (
        <div>
            <div className="text-primary-900 px-6 cursor-pointer" onClick={() => router.back()}>
                <span className='flex gap-x-3'><ArrowLeft className='text-gray-600' size={24} /> HÌNH NỀN</span>
            </div>
