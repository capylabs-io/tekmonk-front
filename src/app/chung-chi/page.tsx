...
import { CertificateHistory, CertificatePdfFieldConfig } from '@/types/certificate';
    ...
    <AuthGuard>
      ...
      <Dialog open={isOpenDetailCertificate} onOpenChange={setIsOpenDetailCertificate}>
        <DialogContent className="w-[1200px] h-[700px] overflow-auto bg-white">
                ...
                <div className="grid grid-cols-1 gap-4">
                  ...
                  <div>
                    <CustomCertificateEditor
                      initialFields={certificateHistorySelected?.certificate.certificatePdfConfig?.fields ? certificateHistorySelected?.certificate.certificatePdfConfig?.fields.map((field: CertificatePdfFieldConfig) => ({
          ...
          <DialogFooter>
            <CommonButton onClick={() => setIsOpenDetailCertificate(false)}>Đóng</CommonButton>
          </DialogFooter>
        </DialogContent>
      </Dialog>
    </AuthGuard>
