...
export const RecruitmentCard = ({
    ...
    return (
        <div className='w-[337px]'>
            <Image src={imageUrl} alt='new pic' width={337} height={100} className='rounded-xl' />
            ...
            <div className='flex flex-wrap gap-x-2 items-center mt-2'>
                {
                    tags && tags.map((tag, index) => {
                        return (
                            <div key={index} className='px-2 py-1 bg-gray-200 text-xs text-gray-500 rounded-md'>
                                {tag}
                            </div>
                        )
                    })
