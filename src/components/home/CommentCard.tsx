    ...
    <div className="flex items-start gap-3 w-full">
      {dataAvatarConfig && dataAvatarConfig.length > 0 ? (
        ...
        <div
          ...
          style={{
            backgroundImage: `url(${
              comment?.commentedBy?.data?.avatar ||
      ...
      <div className="w-[calc(100%-40px-12px)] space-y-0.5">
        ...
        {isEditing ? (
          ...
          <div className="text-sm md:text-base text-wrap break-words whitespace-pre-wrap w-full overflow-y-auto overflow-x-hidden font-thin">
            {content}
          </div>
        )}
      </div>
