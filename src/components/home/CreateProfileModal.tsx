    ...
    return (
        isShowing && (
            <div className="absolute left-0 top-0 z-50 flex h-full w-full items-center justify-center bg-black/60">
                <div className="relative mx-auto flex w-[688px] flex-col justify-center gap-y-5 rounded-xl bg-white py-6">
                    <button
                        type="button"
                        onClick={hide}
                    ...
                    <div className='flex gap-x-3 w-ful px-6'>
                        <Button outlined className='w-full !rounded-3xl'>Huỷ</Button>
