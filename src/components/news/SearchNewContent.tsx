  ...
  return (
    <div className="container mx-auto col-span-3">
      <div className="flex items-center gap-4">
        <button
          className="flex items-center justify-center gap-2 border border-gray-20 rounded-xl w-12 h-12"
          onClick={() => {
            onBack();
          }}
        >
      ...
      {textSearch !== "" && (
        <div className="mt-4 text-gray-50 text-SubheadMd">
          Tìm thấy <span className="text-primary-95">{data?.length}</span> kết
          quả phù hợp với từ khoá:{" "}
