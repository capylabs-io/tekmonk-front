...
export const AvatarItem = ({
  ...
  return (
    <div
      className="border-2 border-gray-30 !bg-white rounded-xl flex justify-center items-end w-[130px] h-[130px] cursor-pointer relative"
      onClick={() => {
    ...
    >
      ...
      <Image
        src={imageUrl || ""}
        className={classNames("absolute", isBackHair ? "z-[1]" : "z-[2]")}
        height={120}
        width={120}
        alt="pic"
      ></Image>
