...
export const BackgroundCard = ({ imageUrl, title, price, isPurchased, onClick }: Props) => {
        ...
        <Dialog>
            <DialogTrigger asChild>
                <button className="w-[170px] cursor-pointer" onClick={handleOnClick}>
                    ...
                    />
                    <div className="w-full mt-2 text-sm text-black truncate text-left">{title}</div>
            ...
            <DialogContent className="sm:max-w-md">
                    ...
                    !purchased ?
                        <>
                            ...
                            <div className='w-full flex flex-col items-center justify-center gap-y-5'>
                                <div className='text-bodySm text-gray-600'>Item đã mua không thể hoàn lại và chỉ mua được một lần.</div>
                                <Image
                                    src={imageUrl}
                                    alt="avatar pic"
                                    width={200}
                ...
                <DialogFooter className="sm:justify-center">
                    ...
                    {!purchased ? <Button className='!px-12 !rounded-3xl text-base !py-2' onClick={() => setPurchased(prev => !prev)}>
                        Mua
                    </Button> : <Button className='!px-12 !rounded-3xl text-base !py-2'>
                        Đến kho đồ
                    </Button>}
